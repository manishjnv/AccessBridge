...
| S-07 | Vision-Assisted Semantic Recovery (3-tier pipeline: Tier 1 heuristic + 200-entry icon lexicon; Tier 2 opt-in Gemini vision; Tier 3 on-device Moondream2 INT8 VLM, ~180 MB opt-in download, Session 23). Per-app MiniLM semantic vocabulary collapses near-duplicate labels. Screenshot-hash dedup cache prevents re-inference. IndexedDB-backed user curation via Vision Lab side panel. Adds `aria-label` + `data-a11y-recovered` to unlabeled buttons/links/icons; audit engine downgrades findings to info-severity. Feature #5 at **100%** of planned scope. | P, SP | Shipped (Tier 1+2+3) | [core/vision/](packages/core/src/vision/) + [content/vision/](packages/extension/src/content/vision/) + [onnx-runtime/models/moondream.ts](packages/onnx-runtime/src/models/moondream.ts) · see [docs/features/vision-recovery.md](docs/features/vision-recovery.md), [docs/operations/vision-model-updates.md](docs/operations/vision-model-updates.md) |
